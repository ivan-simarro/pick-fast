...
import filtering from "../Products/Product/productUtils";
...
export default function Favourites() {
    ...
    return (
        <><div style={{ marginBottom: "3.5rem", display: "flex", justifyContent: "center", alignItems: "center" }} ><Search searchTerm={searchTerm} setSearchTerm={setSearchTerm} /></div><ul className="products">
